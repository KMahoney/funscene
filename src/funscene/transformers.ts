...
export const interpolators = {
    linear: (t: number, a: number, b: number) => (b - a) * t + a,
    cubic: (t: number, a: number, b: number) => (b - a) * Math.pow(t, 3) + a,
    inverseCubic: (t: number, a: number, b: number) => (b - a) * (1.0 - Math.pow(1.0 - t, 3)) + a,
};
